...
[src/aria_ui/aria_dialog_api_base.py](src/aria_ui/aria_dialog_api_base.py)

You can find an example implementation for a simple echo app here:
[src/aria_ui/aria_dialog_api_team.py](src/aria_ui/aria_dialog_api_team.py)
...
To run the text-basd (REPL) interface, execute the python script [src/aria_ui/repl.py](src/aria_ui/repl.py)
